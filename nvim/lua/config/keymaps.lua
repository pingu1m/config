...
-- windows
map("n", "<leader>ww", "<cmd>w<cr><esc>", { desc = "Save File", remap = true })
...
map("v", "J", ":m '>+1<CR>gv=gv", { desc = "Move selected lines" })
map("v", "K", ":m '<-2<CR>gv=gv", { desc = "Move selected lines" })
map("n", "J", "mzJ`z", { desc = "Join lines and keep cursor in place" })
map("v", "<Tab>", ">gv", { desc = "Indent code" })
map("n", "<Tab>", "v><C-\\><C-N>", { desc = "Indent code" })
map("v", "<S-Tab>", "<gv", { desc = "dedent code" })
map("n", "<S-Tab>", "v<<C-\\><C-N>", { desc = "dedent code" })
...
-- map("n", "n", "nzzzv", {desc = "move to next word and center cursor in mid of file"})
-- map("n", "N", "Nzzzv", {desc = "move to prev word and center cursor in mid of file"})
------------------------------------------------------------------------------
-- [[ Highlight on yank ]]
